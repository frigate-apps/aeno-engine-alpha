...
#define CORNFLOWER_BLUE 127 / 255.f, 186 / 255.f, 0 / 255.f, 1


#define RGB_U(red, green, blue) red / 255.f, green / 255.f, blue / 255.f , 1
#define RGBA_U(red, green, blue, alpha) red / 255.f, green / 255.f, blue / 255.f , alpha / 255.f
